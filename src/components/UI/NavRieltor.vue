      ...
      <div class="collapse navbar-collapse sm" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-5 mb-lg-0 ">
          ...
          <li class="nav-item px-lg-3">
            <button class="btn block" v-if="isAuthorized" @click="$router.push('/active_obj')" >Мои объекты</button>
            <button class="btn block " v-else @click="$router.push('/login')" >Мои объекты</button>
          </li>
        </ul>
        <div class="second-content-navbar">
          <button class="svg write float-start" v-if="isAuthorized" @click="$router.push('/add_obj')">
          ...
          <button class="svg float-end" v-else @click="this.$router.push('/login')" >
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
              <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
              <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
            </svg>
