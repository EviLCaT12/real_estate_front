      ...
      <div class="collapse navbar-collapse sm" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
          ...
          <li class="nav-item px-lg-3">
            <button class="btn block"  @click="$router.push('/rieltors')">Риэлторы</button>
          </li>
          <li class="nav-item px-lg-3">
            <button class="btn block"  @click="$router.push('/object')" >Мои объекты</button>
          </li>
        </ul>
        <div class="second-content-navbar">
          <button class="svg write float-start"  @click="$router.push('/objects')">
